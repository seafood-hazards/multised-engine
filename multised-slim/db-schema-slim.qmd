...
common set of flag columns. These are **identical across all five sources** and
never overwrite the original values — they only mark records for review or later
removal. Their detailed semantics will be covered on the forthcoming
quality-control pages.

```{r}
tribble(
  ~Table,        ~Column,      ~Type,     ~Meaning,
  "site",        "qc_flag",    "TEXT",    "Location flag: outside_europe, else NULL.",
  ...
  "measurement", "qc_flag",    "TEXT",    "Value flag: negative / over_range, else NULL.",
