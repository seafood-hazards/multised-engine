...
ICES-DOME / 4Demon) and `subsample.fines_lt63` / `fines_basis` (the derived <63µm
grain-size fraction, on every source with grain-size, i.e. all but 4Demon). These
are documented on the *Source Specific* and *Grain size* pages.
