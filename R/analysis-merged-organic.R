# ── Analysis, merged generation: organic ─────────────────────────────────
# Converted from R/analysis/organic/01_merged_organic.R. The body is unchanged; only the
# hardcoded paths and the console output are parameterised.

analysis_merged_organic <- function(db_dir = multised_db_dir(),
