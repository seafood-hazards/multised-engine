# ── Analysis, merged generation: temporal ────────────────────────────────
# Converted from R/analysis/temporal/01_merged_temporal.R. The body is unchanged; only the
# hardcoded paths and the console output are parameterised.

analysis_merged_temporal <- function(db_dir = multised_db_dir(),
