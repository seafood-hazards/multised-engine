...
utils::globalVariables(c(
  ...
  "best_pref", "bin", "campaign_code", "cas", "cas_no", "cas_number",
  "category", "category_code", "clean_n", "clean_total", "cluster", "code",
  "code_name", "core_id", "corg", "corrected_value", "country",
  ...
  "depth_to", "description", "det_limit_flag", "disposition", "dist_chk",
  ...
  "method_code", "method_description", "method_id", "method_seq_no",
  "method1", "metoa", "min_rel", "monotone", "month", "municipality", "n",
  "n_high", "n_low", "n_rep", "n_years", "name", "name_ices", "name_src",
  ...
  "prio", "project", "project_id", "project_survey_id", "qflag",
  "range_check_flag", "range_flag", "raw_code", "refined_rows", "region",
  "rel_diff", "rel_gap", "repeat_group", "replicate_number",
  ...
  "src_flag", "start", "start_date", "start_year", "station_code",
  "station_group", "station_id", "station_latitude", "station_longitude",
  "station_no", "stem", "subsample_id", "survey_id", "survey_seq_no", "sym",
  "symbol", "t_out", "t_rng", "t_std", "t_val", "thr_hi", "thr_lo", "type",
  "uncrt", "unit", "unit_std", "unit2", "upper_depth", "v", "value",
