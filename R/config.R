...
utils::globalVariables(c(
  ...
  "below_lld", "below_loq", "below_loq_num", "best_pref", "bin", "cas",
  "cas_no", "cas_number", "category", "category_code", "clean_n",
  "clean_total", "cluster", "code", "code_name", "core_id",
  ...
  "det_limit_flag", "dist_to_coast", "dup", "dup_flag", "dup_superseded_by",
  "element", "enough", "est_country", "event_id", "expanded_uncertainty_pct",
  "filtered", "final_total", "fines_lt63", "flag", "fold_vs_med", "frac",
  "frac_class", "fraction", "fraction_range_um", "gear_code", "gkey",
  "group_code", "group_median", "gs_corr", "gsf_id", "GSMF2", "GSMF2_63",
  "half", "has_year", "hi_um", "high", "institute",
  "internal_qa_detection_limit", "internal_qa_quantification_limit",
  "invalid_gs", "is_chem", "is_lld", "lab", "lab_name", "labo", "lat",
  "lat_r", "lat3", "latitude", "layer_lower_boundary",
  "layer_upper_boundary", "limit", "limit_flag", "lld", "lo_um", "lod",
  "logv", "lon", "lon_r", "lon3", "longitude", "loq", "loser_source", "low",
  "lower_depth", "mad_log", "mar_value", "matrix_code", "max_value", "mbsl",
  ...
  "merged_n", "metcu", "method", "method_code", "method_description",
  "method_id", "method1", "metoa", "min_rel", "monotone", "municipality",
  "n", "n_high", "n_low", "n_rep", "name", "name_ices", "name_src",
  "operator", "organisation", "outlier_extreme_flag", "outlier_flag",
  "outlier_stdev_flag", "param", "param_description", "param_id",
  "param_name", "parameter", "parameter_group", "parameter_name", "pref",
  "prio", "project", "project_id", "qflag", "range_check_flag", "range_flag",
  "raw_code", "region", "rel_diff", "rel_gap", "responsible_institute",
  "retained_pct", "sample_id", "sample_no", "sample_time",
  "sample_timestamp", "sample_type", "sample_type_description",
  "sampled_area", "sampling_method", "sampling_tool", "sea_name",
  "sediment_composition", "sediment_content", "sediment_no", "sieve_class",
  "sieve_key", "sieve_um", "sieve_um_std", "site_code", "site_id", "Source",
  "src_flag", "start", "start_year", "station_id", "station_latitude",
  "station_longitude", "station_no", "stem", "subsample_id", "survey_id",
  "survey_seq_no", "sym", "symbol", "t_out", "t_rng", "t_std", "t_val",
  "thr_hi", "thr_lo", "type", "uncrt", "unit", "unit_std", "unit2",
  "upper_depth", "v", "value", "value_analysis", "value_flag", "value_pct",
  "value_sd", "value_std", "value_std_corr", "value_uncrt", "vflag",
  "weight_basis", "winner_source"
))
