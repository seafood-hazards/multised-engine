...
utils::globalVariables(c(
  ...
  "analytical_laboratory_description", "anchor", "anom", "aq_bin",
  "aqua_id", "archive", "Area", "arter", "As", "axis", "B", "Ba",
  "bad_depth", "band", "basis", "batch_id", "bathymetry", "Be",
  "below_lld", "below_loq", "below_loq_num", "best_pref", "bg_ratio_al",
  "bin", "bulk", "bulk_multi", "bulk_single", "Ca", "CaCO3",
  "campaign_code", "capacity", "capacity_tonnes", "capacity_unit", "cas", "cas_no", "cas_number", "category",
  "Category name", "category_code", "category_name", "Catogory", "Cd",
  "Ce", "cell", "chem", "chemical_treatment", "classifiable", "Clay",
  "clean_n", "clean_total", "client", "client_id", "cluster", "Co", "Code",
  "code", "Code name", "code_name", "CodeType", "Comment", "comp_exist",
  "constant", "contractor", "contractor_id", "control_chart_type",
  "core_id", "core_layers", "core_median", "core_name", "CORG", "corg",
  "corg_mgkg", "corg_pct", "corrected_value", "country", "country_code",
  "county", "Cr", "cruise_id", "cruise_no", "cruise_no2", "cruise_type",
  "Cu", "cutoff", "data_col", "data_qualifier", "dataset_code",
  "dataset_group", "dataset_id", "dataset_name", "date_orig", "dcflag",
  "dde", "DDE degrees", "ddn", "DDN degrees", "deep", "denom", "depth",
  "depth_from", "depth_from_cm", "depth_range", "depth_to", "depth_to_cm",
  "Description", "description", "description_raw", "det_limit_flag",
  "direction", "discipline", "disposition", "dist_chk",
  "dist_to_aquaculture", "dist_to_aquaculture_km", "dist_to_coast",
  "dist_to_coast_km", "dup", "dup_flag", "dup_superseded_by", "E", "EF",
  "ef", "ef_p50", "ef_p90", "element", "element_name", "end", "end_day",
  "end_month", "end_year", "english", "enough", "enrich_near",
  "est_country", "event_id", "expanded_uncertainty_pct", "FE", "Fe", "fe",
  "fe_exist", "fe_mgkg", "feature", "few", "filtered", "final_total",
  "fines_lt63", "fines_pct", "fish_types", "flag", "fold_vs_med", "frac",
  "frac_class", "frac_declining", "frac_rising", "fraction",
  "fraction_range_um", "from.date", "fylke", "fylkesnavn", "gear_code",
  ...
  "internal_qa_quantification_limit", "invalid_gs", "is_chem",
  "is_filtered", "is_lld", "K", "k", "k_chosen", "klareringsdato", "kapasitet enhet",
  "klarert kapasitet", "kommune", "kommunenavn", "La", "lab", "lab_name",
  "label", "labo", "lat", "lat3", "lat_r", "latitude", "lawa_code",
  "layer_lower_boundary", "layer_upper_boundary", "Leire", "Li", "limit",
  "limit_flag", "lld", "lld_id", "lo", "lo_oom0.75", "lo_oom1.0", "lo_um",
  "lod", "lod_id", "logv", "loknavn", "loknr", "lon", "lon3", "lon_r",
  "Longitude", "longitude", "loq", "loser_source", "low", "lower_depth",
  "lval", "mad_log", "mar_value", "matrix_code", "MATRX", "max_value",
  "mbsl", "mbsl m", "mean_sil", "measure", "measured_value",
  "measurement_basis", "measurement_date", "measurement_depth",
  "measurement_end", "measurement_id", "measurement_method_code",
  "measurement_project", "measurement_start", "measurement_time",
  "measurement_time_id", "med_log", "med_rel_pct", "med_value",
  "median_bulk", "median_n_cell", "median_rho", "median_s20", "median_s63",
  "median_span", "median_val", "median_value", "merged_n", "merged_rows",
  "metcu", "metcx", "method", "method1", "method2", "method_code",
  "method_description", "method_id", "method_seq_no", "metoa", "metps",
  "metpt", "metric", "metst", "Mg", "mid_depth", "min_rel", "Mn", "Mo",
  "monitoring_station_name", "monotone", "month", "municipality", "N", "n",
  "n_bg", "n_cells", "n_class", "n_classifiable", "n_cores",
  "n_distinct_rel", "n_global", "n_high", "n_layers", "n_low", "n_off",
  "n_off10", "n_rep", "n_sites", "n_values", "n_years", "Na", "Name",
  ...
  "param_id", "param_name", "parameter", "parameter_group",
  "parameter_name", "PARGROUP", "Pb", "pct_bg", "pct_classifiable",
  "pct_ef", "pct_gt5", "pct_lt1", "pct_pristine", "pct_strict",
  "physical_treatment", "placement", "plassering", "platform_type", "pref",
  "prio", "pristine_ef", "pristine_strict", "proficiency_testing",
  ...
  "sample_id", "sample_id2", "sample_method", "sample_no",
  "sample_ref_code", "sample_seq_no", "sample_time", "sample_timestamp",
  "sample_type", "sample_type_description", "sampled_area",
  "Sampling tool", "sampling_method", "sampling_tool",
  "SamplingTool serial ID", "Sand", "Sc", "Se", "sea_area", "sea_name",
  "season", "sediment_composition", "sediment_content", "sediment_no",
  "separated", "seq_number", "shift_p90", "Si", "sieve_class", "sieve_key",
  "sieve_um", "sieve_um_std", "sieved", "sieved20", "sieved20_multi",
  "sieved20_single", "sieved63", "sieved63_multi", "sieved63_single",
  "Silt", "site_code", "site_id", "site_name", "Slam", "slope",
  "slope_log10", "Source", "span", "species", "Sr", "src_flag", "start",
  "start_date", "start_day", "start_month", "start_year", "Stasjon",
  "Stasjon_kort", "station", "Station number", "station_code",
  "station_group", "station_id", "station_latitude", "station_longitude",
  "station_name", "station_no", "station_type", "stem", "strict",
  "stripped", "sub_no", "subsample_id", "surf", "survey_end", "survey_id",
  "survey_seq_no", "survey_start", "sym", "symbol", "t_out", "t_rng",
  "t_std", "t_val", "TC", "thr_hi", "thr_lo", "threshold", "Ti", "to.date",
  "TOC", "tool_id", "total", "trukket dato", "TS", "type",
  "uncertainty_method", "uncrt", "unit", "unit2", "unit_std",
  "upper_depth", "utm33_x", "utm33_y", "V", "v", "val", "Value", "value",
  "value_analysis", "value_flag", "value_mgkg", "value_pct", "value_sd",
  "value_std", "value_std_corr", "value_uncrt", "vannmiljo", "variable",
