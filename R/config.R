...
utils::globalVariables(c(
  ...
  "basis", "below_lld", "below_loq", "below_loq_num", "best_pref", "bin",
  "cas", "cas_no", "cas_number", "category", "category_code", "clean_n",
  "clean_total", "cluster", "code", "code_name", "core_id", "corg",
  ...
  "det_limit_flag", "disposition", "dist_chk", "dist_to_aquaculture",
  "dist_to_coast", "dup", "dup_flag", "dup_superseded_by", "element",
  "enough", "est_country", "event_id", "expanded_uncertainty_pct", "fe",
  "filtered", "final_total", "fines_lt63", "flag", "fold_vs_med", "frac",
  "frac_class", "fraction", "fraction_range_um", "gear_code", "gkey",
  "group", "group_code", "group_median", "gs_corr", "gsf_id", "GSMF2",
  ...
  "merged_n", "merged_rows", "metcu", "method", "method_code",
  "method_description", "method_id", "method1", "metoa", "min_rel",
  "monotone", "municipality", "n", "n_high", "n_low", "n_rep", "n_years",
  "name", "name_ices", "name_src", "operator", "organisation",
