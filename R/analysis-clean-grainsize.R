# ── Analysis, clean generation: grainsize ────────────────────────────────
# Converted from R/analysis/grainsize/01_clean_grainsize.R. The body is unchanged; only the
# hardcoded paths and the console output are parameterised.

analysis_clean_grainsize <- function(db_dir = multised_db_dir(),
