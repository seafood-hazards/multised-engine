# ── Analysis, merged generation: merged_summary ──────────────────────────
# Converted from R/analysis/merged_summary/01_merged_data_summary.R. The body is unchanged; only the
# hardcoded paths and the console output are parameterised.

analysis_merged_data_summary <- function(db_dir = multised_db_dir(),
  ...
  out_dir <- file.path(out_dir, "merged_summary")
