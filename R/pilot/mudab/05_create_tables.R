...
walk(
  c("sediment", "sample", "lod", "reference_material",
    "analysis_method", "measurement_time", "survey",
    "parameter", "station", "code_lookup"),
...
# --- 4. Independent table: measurement_time ---
dbExecute(con, "
...
# --- 5. Independent table: analysis_method ---
dbExecute(con, "
...
# --- 6. Independent table: reference_material ---
dbExecute(con, "
...
# --- 11. Write data in dependency order ---
dbWriteTable(con, "code_lookup",         df_code_lookup,       append = TRUE)
dbWriteTable(con, "station",             df_station,           append = TRUE)
dbWriteTable(con, "parameter",           df_parameter,         append = TRUE)
dbWriteTable(con, "measurement_time",    df_measurement_time,  append = TRUE)
dbWriteTable(con, "analysis_method",     df_analysis_method,   append = TRUE)
dbWriteTable(con, "reference_material",  df_reference_material, append = TRUE)
dbWriteTable(con, "survey",              df_survey,            append = TRUE)
dbWriteTable(con, "lod",                 df_lod,               append = TRUE)
