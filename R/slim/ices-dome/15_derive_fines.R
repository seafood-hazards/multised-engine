...
# ── 0. Open slim db ──────────────────────────────────────────────────────────
# Grain-size derivation step (source-specific; ICES-DOME here). Adds the per-sample
...
# ICES-DOME reports the cumulative code GSMF63 ("Grain Size Mass Fraction <63
# micron, silt/clay", verified from the pilot parameter table): the <63 um
