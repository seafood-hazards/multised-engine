...
# Converted from R/analysis/background/02_refined_background_gsnorm.R. The body is unchanged; only the
# hardcoded paths and the console output are parameterised.

analysis_refined_background_gsnorm <- function(db_dir = multised_db_dir(),
